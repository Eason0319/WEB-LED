...
// SSID & Password
const char* ssid = "AndroidAP9EED";
const char* password = "gbnq6338";
    ...
    <head>\
      <style>\
        body{ display: flex; flex-direction: column; align-items: center;}\
         a { background: #F28500; font-family: Arial; width: 200px; height: 50px; margin: 20px; font-size: 30pt; text-decoration: none; border-radius: 10px; padding: 3px;}\
      </style>\
    </head>\
    <body>\
